...
* SWF Activity Module XML learning interaction data file converter.
* Converts externally loaded XML into an array of objects, the same as that retrieved from the SWF Activity Modules learning interactions database.
*
*/
...
Example FLA/doc class code:
	...
	import com.matbury.sam.ConvertXML;
